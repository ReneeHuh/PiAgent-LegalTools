...
export type ProviderId = "courtlistener" | "scholar";
...
export type ProviderRawResult = ScholarRawResult | CourtListenerRawResult;
...
export function normalizeProviderResult(
  ...
  return {
    ...
    docketNumber,
    publicationStatus: provider === "courtlistener" ? (raw as CourtListenerRawResult).status : undefined,

...
- Google Chrome for browser-based case research, or set `LEGAL_RESEARCH_CHROME_PATH` to a Chrome or Edge executable. See [browser configuration](extensions/legal-case-research/README.md#configuration).

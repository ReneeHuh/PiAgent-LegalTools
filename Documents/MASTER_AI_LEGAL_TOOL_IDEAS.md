...
The preferred subset selected for further development is expanded in [Selected AI Legal Tools: Expanded Product Report](SELECTED_AI_LEGAL_TOOLS_REPORT.md).
...
- **S1** — [Deep Research Report: Legal Tools for a Pro Se Person to Add to Pi Agent](deep-research-report-legal-tools-for-pi-agent.md)
- **S2** — [Legal AI Tool Suite for the pi Agent — Ideas & Build Plan](Old%20Docs/LegalTools/legal-ai-tools-report.md)
- **S3** — [Legal Tool Ideas — Beyond the Core Five](Old%20Docs/LegalTools/tool-ideas.html)
- **S4** — [Legal Agent Tools — Research Report](Old%20Docs/LegalTools/legal-agent-tools-report.html)
- **S5** — [Legal-AI Tools and Agent Architecture for a Personal-Injury Practice](Old%20Docs/LegalTools/deep-research-report.md)
- **S6** — [Pro Se Legal Tooling — Design Report](CaseLawSearch/legal-tooling-design-report.html)
- **S7** — [How Lawyers Actually Search for Case Law](CaseLawSearch/lawyer-case-law-research-workflow-report.html)
- **S8** — [Unified Legal Research Extension Plan](CaseLawSearch/unified-legal-research-extension-plan.html)
- **S9** — [Michigan Case-Treatment and Shepardizing Documents](Old%20Docs/CaseSheparding/MICHIGAN_CASE_SHEPARDIZING_GUIDE.md), [Automation Plan](Old%20Docs/CaseSheparding/AUTOMATION_PLAN.md), [full research report](Old%20Docs/CaseSheparding/New%20Text%20Document.txt), and the associated skill references
- **S10** — Dedicated plans for [Get Cases](Old%20Docs/LegalTools/get-cases-plan.html), [Case Chat](Old%20Docs/LegalTools/case-chat-plan.html), [Shepard Report](Old%20Docs/LegalTools/shepard-plan.html), [Verification](Old%20Docs/LegalTools/verify-plan.html), and [Multi-LLM Review](Old%20Docs/LegalTools/review-plan.html)
- **S11** — [Multi-call summarization research](deep-research-report%20for%20summarizer.md), [case-summary prompt](CaseLawSearch/summary%20prompt.txt), and [summary-audit prompt](CaseLawSearch/summary%20audit%20prompt.txt)

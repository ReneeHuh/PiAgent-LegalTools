...
These capabilities are documented in the bundled [extension](pi-docs/extensions.md), [skill](pi-docs/skills.md), [prompt-template](pi-docs/prompt-templates.md), and [package](pi-docs/packages.md) documentation.
...
The example is documented in [Subagent Example](pi-docs/examples/extensions/subagent/README.md).
...
A Pi package is the delivery container. The existing `pi-unified-legal-research` package, now at [CaseLawSearch](CaseLawSearch/legal-research/README.md), is already structured this way.
...
The initial package scaffold is now available at [pi-legal-workbench](pi-legal-workbench/README.md).
...
See [Selected AI Legal Tools: Expanded Product Report](SELECTED_AI_LEGAL_TOOLS_REPORT.md) for the detailed product scope, tool combinations, shared artifacts, build sequence, and legal guardrails.

...
For the Pi-specific choice between extensions, skills, prompts, packages, subagents, scripts, and SDK/RPC integration, see [Implementing the Legal Tool Suite in Pi Agent](PI_AGENT_IMPLEMENTATION_OPTIONS.md).
...
The `pi-unified-legal-research` package, checked in at [CaseLawSearch](CaseLawSearch/legal-research/README.md), is the search extension for this project and the correct foundation for Modules A and B. Its documented version is 0.17.1 and it already provides:
...
- [Pi legal-research extension README](CaseLawSearch/legal-research/README.md)
- [Legal AI Tool Suite — Ideas & Build Plan](Old%20Docs/LegalTools/legal-ai-tools-report.md)
- [Legal Tool Ideas — Beyond the Core Five](Old%20Docs/LegalTools/tool-ideas.html)
- [Pro Se Legal Tooling — Design Report](CaseLawSearch/legal-tooling-design-report.html)
- [How Lawyers Actually Search for Case Law](CaseLawSearch/lawyer-case-law-research-workflow-report.html)
- [Legal-AI Tools and Agent Architecture for a Personal-Injury Practice](Old%20Docs/LegalTools/deep-research-report.md)
- [Deep Research Report: Legal Tools for a Pro Se Person to Add to Pi Agent](deep-research-report-legal-tools-for-pi-agent.md)
- [Michigan Case Shepardizing Guide](Old%20Docs/CaseSheparding/MICHIGAN_CASE_SHEPARDIZING_GUIDE.md)
- [Michigan Shepardizing Automation Plan](Old%20Docs/CaseSheparding/AUTOMATION_PLAN.md)
- Dedicated plans for [case chat](Old%20Docs/LegalTools/case-chat-plan.html), [cited-by treatment reporting](Old%20Docs/LegalTools/shepard-plan.html), [citation/fact verification](Old%20Docs/LegalTools/verify-plan.html), and [multi-model document review](Old%20Docs/LegalTools/review-plan.html)
